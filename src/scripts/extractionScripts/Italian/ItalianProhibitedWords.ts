...
export const prohibitedItalianPrepositions = splitText('da dal dalla dall dallo dai dalle dagli di del dell dello delle della dei degli a ai al all alla alle allo ai agli in nel nell nella nello nei negli con coi su sul sull sullo sulla sui sugli per tra fra davanti dietro contro dentro secondo lungo vicino lontano durante mediante eccetto escluso intorno fuori luogo somiglianza', /[\s,]+/);
